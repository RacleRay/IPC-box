...
void run_server(char *shm_addr, int sem_id, int msg_size, int msg_count);
...
int main(int argc, char *argv[]) {
    ...
    // communicate
    run_server(shm_addr, sem_id, args.msg_size, args.msg_count);
...
void run_server(char *shm_addr, int sem_id, int msg_size, int msg_count) {
    ...
    printf("Start semaphores shm server test \n");
    ...
    printf("End semaphores shm server test \n");
